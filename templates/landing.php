...
.provider-btn.is-disabled:hover {
  box-shadow: var(--shadow);
  transform: none;
}
.provider-btn svg {
...
<section class="providers" id="get-started">
  <div class="providers-inner">
    ...
    <div class="provider-btns">
      ...
      <?php else: ?>
      <span class="provider-btn is-disabled" title="Set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in .env to enable Google sign-in">
      <?php endif; ?>
      ...
      <?php else: ?>
      <span class="provider-btn is-disabled" title="Set MICROSOFT_CLIENT_ID and MICROSOFT_CLIENT_SECRET in .env to enable Microsoft sign-in">
      <?php endif; ?>
      ...
      <?php else: ?>
      <span class="provider-btn is-disabled" title="Set GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET in .env to enable GitHub sign-in">
      <?php endif; ?>
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
